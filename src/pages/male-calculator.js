...
function IndexPage() {
  ...
  const calculate = () => {
    let calories = cHeightm(height) + cWeight(weight, goal) + cActivitym(activity) + cLiftingm(lifting) + cCardiom(cardio, cardio2);
    ...
    <Layout >
      <div className="male">
        ...
        <div className="section">
          ...
          <h4>{miL(height)}</h4>
          <SlideBar range={[160, 244]} values={[height]} onUpdate={setHeight} />
        </div>
        <div className="section">
          <h5>Current Weight</h5>
          <p>Slide the bar to select your accurate <strong>weight</strong></p>
          <h4>{miW(weight)}</h4>
          <SlideBar range={[54, 181]} values={[weight]} onUpdate={setWeight} />
        </div>
        <div className="section">
          <h5>Goal Weight</h5>
          <p>Slide the bar to select your <strong>goal weight</strong></p>
          <h4>{miW(goal)}</h4>
          <SlideBar range={[54, 136]} values={[goal]} onUpdate={setGoal} />
        </div>
        <div className="section">
          <h5>Activity</h5>
        ...
        <div className="section">
          ...
          <ButtonBar onSelectionLabel={"Duration of each session?"} onSelection={["10 min", "20 min", "30-45 min", "60 min"]} selections={["None", "1-2x/week", "3x/week", "4-5x/week", "6x/week"]} onUpdate={setLifting} />       </div>
        <div className="section">
          <h5>Cardio + Group Fitness Frequency</h5>
          <p>How often do you train your <strong>cardiovascular system</strong>?</p>
          <ButtonBar onSelectionEvent={setCardio2} onSelectionLabel={"Duration of each session?"} onSelection={["10 min", "20 min", "30-45 min", "60 min"]} selections={["None", "1-2x/week", "3x/week", "4-5x/week", "6x/week"]} onUpdate={setCardio} /> </div>
        <div className="section">
          <h5>Current Diet</h5>
